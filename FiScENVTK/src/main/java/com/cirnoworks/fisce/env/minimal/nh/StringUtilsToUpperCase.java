 ...
 * 
 */
public class StringUtilsToUpperCase extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		thread.nativeReturnHandle(heap.putString(in.toLowerCase()));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.toLowerCase.(Ljava/lang/String;)Ljava/lang/String;";
	}
