 ...
 * 
 */
public class MathLog10 extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		double param1 = Double.longBitsToDouble(TypeUtil.intToLong(args[0],
				args[1]));
		thread.nativeReturnWide(Double.doubleToRawLongBits(Math.log10(param1)));
	}
	...
	public String getUniqueName() {
		return "java/lang/Math.log10.(D)D";
	}
