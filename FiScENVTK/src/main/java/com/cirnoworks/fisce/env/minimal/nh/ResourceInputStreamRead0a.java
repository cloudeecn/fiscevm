...
public class ResourceInputStreamRead0a implements INativeHandler {
	private static final int POS_BUF_SIZE = 4096;

	private BaseToolkit toolkit;

	public ResourceInputStreamRead0a(BaseToolkit toolkit) {
		super();
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/ResourceInputStream.read0.(Ljava/lang/String;I)I";
	}
