 ...
 * 
 */
public class StringUtilsIsIdentifierIgnorable extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.isIdentifierIgnorable(args[0]) ? 1 : 0);
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.isIdentifierIgnorable.(I)Z";
	}
