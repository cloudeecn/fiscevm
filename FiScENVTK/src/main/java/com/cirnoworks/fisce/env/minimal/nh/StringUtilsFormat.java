 ...
 * 
 */
public class StringUtilsFormat extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		int paramsHandle = args[1];
		int paramsCount = heap.getArrayLength(paramsHandle);
		String[] params = new String[paramsCount];
		for (int i = 0; i < paramsCount; i++) {
			params[i] = heap.getString(heap.getArrayHandle(paramsHandle, i));
		}
		thread.nativeReturnHandle(heap.putString(String.format(in, (Object[]) params)));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.format.(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;";
	}
