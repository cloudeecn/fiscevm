 ...
 * 
 */
public class DoubleDoubleToLongBits extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnWide(Double.doubleToLongBits(Double
	...
	public String getUniqueName() {
		return "java/lang/Double.doubleToRawLongBits.(D)J";
	}
