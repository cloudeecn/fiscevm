 ...
 * 
 */
public class StringUtilsToUpperCaseI extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.toUpperCase(args[0]));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.toUpperCase.(I)I";
	}
