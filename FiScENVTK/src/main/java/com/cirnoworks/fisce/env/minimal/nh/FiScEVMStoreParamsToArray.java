 ...
 *
 */
public class FiScEVMStoreParamsToArray extends NativeHandlerTemplate {
	...
	/*
	 * public static native void storeParamsToArray(int begin, int[] target, int
	 * pos, int count);
	 *
	 * @see com.cirnoworks.fisce.vm.INativeHandler#getUniqueName()
	 */
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/FiScEVM.storeParamsToArray.(I[III)V";
	}
