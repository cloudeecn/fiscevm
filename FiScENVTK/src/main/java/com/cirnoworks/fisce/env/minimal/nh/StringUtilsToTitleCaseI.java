 ...
 * 
 */
public class StringUtilsToTitleCaseI extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.toTitleCase(args[0]));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.toTitleCase.(I)I";
	}
