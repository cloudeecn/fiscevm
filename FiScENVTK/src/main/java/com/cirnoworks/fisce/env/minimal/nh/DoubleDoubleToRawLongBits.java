 ...
 * 
 */
public class DoubleDoubleToRawLongBits extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnWide(args[0] << 32 + (args[1] & 0xffffffffl));
	}
	...
	public String getUniqueName() {
		return "java/lang/Double.doubleToLongBits.(D)J";
	}
