...
public class ThreadIsAlive extends NativeHandlerTemplate {

	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		int handle = args[0];
		thread.nativeReturnInt(((JThreadManager) context.getThreadManager())
				.isAlive(handle) ? 1 : 0);
	}

	public String getUniqueName() {
		return "java/lang/Thread.isAlive.()Z";
	}
