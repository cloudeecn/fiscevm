 ...
 * 
 */
public class MathIEEEremainder extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		double param2 = Double.longBitsToDouble(TypeUtil.intToLong(args[2],
				args[3]));
		thread.nativeReturnWide(Double.doubleToRawLongBits(Math.IEEEremainder(
				param1, param2)));
	}
	...
	public String getUniqueName() {
		return "java/lang/Math.IEEEremainder.(DD)D";
	}
