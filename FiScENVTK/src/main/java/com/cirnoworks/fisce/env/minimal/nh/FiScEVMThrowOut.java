...
public class FiScEVMThrowOut implements INativeHandler {

	public void dealNative(int[] args, VMContext context, IThread thread)
			throws VMException, VMCriticalException {
		throw new VMCriticalException(context.getClass(args[0]).getName());
	}

	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/FiScEVM.throwOut.(Ljava/lang/Throwable;)V";
	}
