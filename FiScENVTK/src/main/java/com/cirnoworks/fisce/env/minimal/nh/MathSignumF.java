 ...
 * 
 */
public class MathSignumF extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		thread.nativeReturnWide(Double.doubleToRawLongBits(Math.signum(param1)));
	}
	...
	public String getUniqueName() {
		return "java/lang/Math.signum.(F)F";
	}
