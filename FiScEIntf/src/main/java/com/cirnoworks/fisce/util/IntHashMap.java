...
/*
 * Note: originally released as org.apache.commons.lang.IntHashMap
...
public class IntHashMap<E> {
	...
	private static class Entry<EE> {
		 ...
		 */
		protected Entry(int key, EE value, Entry<EE> next) {
			this.key = key;
			this.value = value;
			this.next = next;
		}
	 ...
	 * @see #get(int)
	 */
	public Object put(int key, E value) {
