...
public abstract class BasicPermission extends Permission implements
	 ...
	 *            {@code BasicPermission}.
	 * @return {@code true} if the specified object is equal to this
	 *         {@code BasicPermission}, otherwise {@code false}.
	 */
	@Override
	...
	/**
	 * Returns the actions associated with this permission. Since
	 * {@code BasicPermission} instances have no actions, an empty string is
	 * returned.
	 * 
	...
	/**
	 * Checks if {@code thisName} implies {@code thatName}, accordingly to
	 * hierarchical property naming convention. It is assumed that names cannot
	...
	public PermissionCollection newPermissionCollection() {
		return new DummyPermissionCollection();
	}
}