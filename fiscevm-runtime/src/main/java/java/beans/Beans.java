...
public class Beans {
	 ...
	 * </p>
	 * <p>
	 * If the bean is an instance of java.applet.Applet, <code>Beans</code> will
	 * do some special initialization for this applet bean. First,
	 * <code>Beans</code> will set the default AppletStub and AppletContext for
	 * the applet bean (If the specified <code>AppletInitializer</code> is not
	 * null, <code>Beans</code> will call the
	...
	public static Object instantiate(ClassLoader cls, String beanName,
			BeanContext context, Object initializer) throws IOException,
			ClassNotFoundException {
		return internalInstantiate(cls, beanName, context, null);
	}
