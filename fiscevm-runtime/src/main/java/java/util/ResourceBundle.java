...
/**
 * {@code ResourceBundle} is an abstract class which is the superclass of
 * classes which provide {@code Locale}-specific resources. A bundle contains a
 * number of named resources, where the names are {@code Strings}. A bundle may
 * have a parent bundle, and when a resource is not found in a bundle, the
 * parent bundle is searched for the resource. If the fallback mechanism reaches
 * the base bundle and still can't find the resource it throws a
...
public abstract class ResourceBundle {
	...
	/**
	 * The parent of this {@code ResourceBundle} that is used if this bundle
	 * doesn't include the requested resource.
	 */
	...
	private static final HashMap<Object, Hashtable<String, ResourceBundle>> cache = new HashMap<Object, Hashtable<String, ResourceBundle>>();
	...
	/**
	 * Gets the {@code Locale} of this {@code ResourceBundle}. In case a bundle
	 * was not found for the requested {@code Locale}, this will return the
	 * actual {@code Locale} of this resource bundle that was found after doing
	 * a fallback.
	 * 
	...
	/**
	 * Returns the named resource from this {@code ResourceBundle}, or null if
	...
	/**
	 * Sets the parent resource bundle of this {@code ResourceBundle}. The
	 * parent is searched for resources which are not found in this
	 * {@code ResourceBundle}.
	 * 
	 * @param bundle
	...
	public static class Control {
		...
		public ResourceBundle newBundle(String baseName, Locale locale,
			...
			if (JAVAPROPERTIES == format) {
				...
				if (streams != null) {
					try {
						ret = new PropertyResourceBundle(new InputStreamReader(
								streams));
