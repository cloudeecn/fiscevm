...
/**
 * {@code Locale} represents a language/country/variant combination. It is an
...
public final class Locale implements Cloneable, Serializable {
	...
	static {
		defaultLocale = new Locale("un", "2D", "");
	}
	...
	/**
	 * Constructs a new {@code Locale} using the specified language and country
	 * codes.
	 *
	 * @param language
	 *            the language this {@code Locale} represents.
	 ...
	 *             if {@code language}, {@code country}, or {@code variant} is
	 *             {@code null}.
	 */
	...
	/**
	 * Returns a new {@code Locale} with the same language, country and variant
	 * codes as this {@code Locale}.
	 *
	...
	/**
	 * Compares the specified object to this {@code Locale} and returns whether
	 * they are equal. The object must be an instance of {@code Locale} and have
	...
	/**
	 * Gets the list of installed {@code Locale}. At least a {@code Locale} that
	 * is equal to {@code Locale.US} must be contained in this array.
	 *
	...
	/**
	 * Gets the country code for this {@code Locale} or an empty string of no
	 * country was set.
	 *
	...
	/**
	 * Gets the full country name in the default {@code Locale} for the country
	 * code of this {@code Locale}. If there is no matching country name, the
	...
	/**
	 * Gets the full country name in the specified {@code Locale} for the
	 * country code of this {@code Locale}. If there is no matching country
	 * name, the country code is returned.
	 *
	 * @param locale
	...
	/**
	 * Gets the full language name in the default {@code Locale} for the
	 * language code of this {@code Locale}. If there is no matching language
	 * name, the language code is returned.
	 *
	 * @return a language name.
	 */
	public final String getDisplayLanguage() {
		return "Unified Language";
	}

	/**
	 * Gets the full language name in the specified {@code Locale} for the
	 * language code of this {@code Locale}. If there is no matching language
	 * name, the language code is returned.
	 *
	 * @param locale
	 ...
	 * {@code Locale} for the codes of this {@code Locale}.
	 *
	...
	/**
	 * Gets the full variant name in the default {@code Locale} for the variant
	 * code of this {@code Locale}. If there is no matching variant name, the
	 * variant code is returned.
	 *
	...
	/**
	 * Gets the full variant name in the specified {@code Locale} for the
	 * variant code of this {@code Locale}. If there is no matching variant
	 * name, the variant code is returned.
	 *
	 * @param locale
	 *            the {@code Locale} for which the display name is retrieved.
	 * @return a variant name.
	...
	/**
	 * Gets the language code for this {@code Locale} or the empty string of no
	 * language was set.
	 *
	...
	/**
	 * Gets the variant code for this {@code Locale} or an empty {@code String}
	 * of no variant was set.
	 *
	 ...
	 *             if there is a {@code SecurityManager} in place which does not
	...
	/**
	 * Returns the string representation of this {@code Locale}. It consists of
	 * the language followed by the country and at the end the variant. They are
