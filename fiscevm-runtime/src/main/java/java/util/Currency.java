...
public final class Currency implements Serializable {
	 ...
	 * 
	 * @return the symbol for this {@code Currency} in the default
	 *         {@code Locale}.
	 */
	 ...
	 * {@code Locale.JAPANESE, new Locale("en","")}), then the ISO 4217 currency
	 * code is returned.
	 * <p>
	 * First the locale's resource bundle is checked, if the locale has the same
	 * currency, the CurrencySymbol in this locale bundle is returned.
	 * <p>
	 * Then a currency bundle for this locale is searched.
	 * <p>
	 * If a currency bundle for this locale does not exist, or there is no
	 * symbol for this currency in this bundle, then the ISO 4217 currency code
	 * is returned.
	 * <p>
	 * 
	 * @param locale
	 *            the locale for which the currency symbol should be returned.
	 * @return the representation of this {@code Currency}'s symbol in the
	 *         specified locale.
	 */
