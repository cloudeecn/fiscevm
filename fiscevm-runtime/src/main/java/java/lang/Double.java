...
public final class Double extends Number implements Comparable<Double> {
	...
	/**
	 * The {@link Class} object that represents the primitive type
	 * {@code double}.
	 * 
	 * @since 1.1
	 */
	 ...
	 * @return {@code true} if {@code d} is <em>Not-a-Number</em>; {@code false}
	...
	public static double parseDouble(String string)
			throws NumberFormatException {
		return FiScEVM.stringToDouble(string);
	}
