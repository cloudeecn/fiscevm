...
_FY_EXPORT void fy_strDestroy(fy_memblock *mem, fy_str *string);
_FY_EXPORT fy_str *fy_strAppend(fy_memblock *mem, fy_str *this,
		const fy_str *string, fy_exception *exception);
_FY_EXPORT fy_str *fy_strAppendChar(fy_memblock *mem, fy_str *this, fy_char ch,
		fy_exception *exception);
_FY_EXPORT fy_str *fy_strAppendUTF8(fy_memblock *mem, fy_str *this,
		const char* utf8, fy_int size, fy_exception *exception);
_FY_EXPORT fy_str *fy_strSubstring(fy_memblock *mem, fy_str *this, fy_int begin,
		fy_int end);
...
_FY_EXPORT fy_boolean fy_strEndsWith(fy_str *this, fy_str *comp);

_FY_EXPORT void fy_strClear(fy_str *this);
...
_FY_EXPORT fy_str *fy_strCreateClone(fy_memblock *mem, fy_str *from,
		fy_exception *exception);
