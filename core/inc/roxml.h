 ...
 * \see roxml_release
 */
char * ROXML_API roxml_get_content(node_t *n, char * buffer, int bufsize,
		int * size);
 ...
 * \endcode
 */
node_t * ROXML_API roxml_add_node(node_t * parent, int position, int type,
 ...
 * to generate the following xml bloc:
 ...
 \endverbatim
 */
int ROXML_API roxml_commit_changes(node_t *n, char * dest, char ** buffer,
		int human);
