 ...
 * {@code iterator()} and {@code size()} to create an immutable collection. To
 * create a modifiable collection it's necessary to override the {@code add()}
 * method that currently throws an {@code UnsupportedOperationException}.
 * 
 * @since 1.2
 */
public abstract class AbstractCollection<E> implements Collection<E> {
	...
	/**
	 * Attempts to add all of the objects contained in {@code collection} to the
	 * contents of this {@code Collection} (optional). This implementation
	 ...
	 * {@code Collection} does not support adding elements, an
	 * {@code UnsupportedOperationException} is thrown.
	 * <p>
	 * If the passed {@code Collection} is changed during the process of adding
	 * elements to this {@code Collection}, the behavior depends on the behavior
	 * of the passed {@code Collection}.
	 * 
	 * @param collection
	 ...
	 * (optional). This implementation iterates over this {@code Collection} and
	 * calls the {@code remove} method on each element. If the iterator does not
	 * support removal of elements, an {@code UnsupportedOperationException} is
	 * thrown.
	 * <p>
	 * Concrete implementations usually can clear a {@code Collection} more
	 * efficiently and should therefore overwrite this method.
	 * 
	 * @throws UnsupportedOperationException
	 *             it the iterator does not support removing elements from this
	 *             {@code Collection}
	 * @see #iterator
	 * @see #isEmpty
	 * @see #size
	 ...
	 * implementation iterates over this {@code Collection} and tests, whether
	 * any element is equal to the given object. If {@code object != null} then
	...
	/**
	 * Returns if this {@code Collection} contains no elements. This
	 * implementation tests, whether {@code size} returns 0.
	 * 
	 ...
	 * elements are returned by the {@link Iterator} is not defined unless the
	 * instance of the {@code Collection} has a defined order. In that case, the
	 ...
	 * {@code Collection} and tests for each element {@code e} returned by the
	 * iterator, whether {@code e} is equal to the given object. If
	 * {@code object != null} then this test is performed using
	 * {@code object.equals(e)}, otherwise using {@code object == null}. If an
	 * element equal to the given object is found, then the {@code remove}
	 * method is called on the iterator and {@code true} is returned,
	 * {@code false} otherwise. If the iterator does not support removing
	 * elements, an {@code UnsupportedOperationException} is thrown.
	 * 
	 * @param object
	 ...
	 * each element {@code e} returned by the iterator, whether it is contained
	 * in the specified {@code Collection}. If this test is positive, then the
	 * {@code remove} method is called on the iterator. If the iterator does not
	 ...
	 * in the {@code Collection} passed (optional). After this method returns
	 * this {@code Collection} will only contain elements that also can be found
	 * in the {@code Collection} passed to this method.
	 * <p>
	 * This implementation iterates over this {@code Collection} and tests for
	 * each element {@code e} returned by the iterator, whether it is contained
	 * in the specified {@code Collection}. If this test is negative, then the
	 * {@code remove} method is called on the iterator. If the iterator does not
	 * support removing elements, an {@code UnsupportedOperationException} is
	 * thrown.
	 * 
	 ...
	 * by concrete {@code Collection} implementations.
	 * 
	 * @return how many objects this {@code Collection} contains, or
	 *         {@code Integer.MAX_VALUE} if there are more than
	...
	/**
	 * Returns the string representation of this {@code Collection}. The
