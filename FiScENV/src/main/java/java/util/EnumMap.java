...
public class EnumMap<K extends Enum<K>, V> extends AbstractMap<K, V> implements
	...
	private static class EnumMapEntrySet<KT extends Enum<KT>, VT> extends
		...
		public Object[] toArray(Object[] array) {
			...
			for (; index < size; index++) {
				...
				entryArray[index] = new MapEntry<KT, VT>(entry.getKey(),
						entry.getValue());
			}
	 ...
	 * 
	 * @param keyType
	 *            the class object giving the type of the keys used by this
	 *            {@code EnumMap}.
	...
	/**
	 * Constructs an {@code EnumMap} using the same key type as the given
	 * {@code EnumMap} and initially containing the same mappings.
	 * 
	 * @param map
	 *            the {@code EnumMap} from which this {@code EnumMap} is
	 *            initialized.
	 * @throws NullPointerException
	...
	/**
	 * Constructs an {@code EnumMap} initialized from the given map. If the
	 * given map is an {@code EnumMap} instance, this constructor behaves in the
	 * exactly the same way as {@link EnumMap#EnumMap(EnumMap)} . Otherwise, the
	 * given map should contain at least one mapping.
	 * 
	 * @param map
	 *            the map from which this {@code EnumMap} is initialized.
	 * @throws IllegalArgumentException
	 *             if {@code map} is not an {@code EnumMap} instance and does
	 ...
	 * @return {@code true} if this {@code EnumMap} contains the specified
	...
	/**
	 * Returns a {@code Set} containing all of the mappings in this
	 * {@code EnumMap}. Each mapping is an instance of {@link Map.Entry}. As the
	 * {@code Set} is backed by this {@code EnumMap}, changes in one will be
	 ...
	 * specified {@code Object} is an {@code EnumMap} and both {@code EnumMap}s
	 * contain the same mappings.
	 * 
	 * @param object
	 *            the {@code Object} to compare with this {@code EnumMap}.
	 * @return boolean {@code true} if {@code object} is the same as this
	 *         {@code EnumMap}, {@code false} otherwise.
	 * @see #hashCode()
	 * @see #entrySet()
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Returns a set of the keys contained in this {@code EnumMap}. The
	 * {@code Set} is backed by this {@code EnumMap} so changes to one are
	 * reflected in the other. The {@code Set} does not support adding.
	 * <p>
	 ...
	 * @throws NullPointerException
	 *             if the key or value is {@code null} and this {@code EnumMap}
	 *             does not support {@code null} keys or values.
	 */
	@Override
	@SuppressWarnings("unchecked")
	 ...
	 * @throws NullPointerException
	 *             if a key or value is {@code null} and this {@code EnumMap}
	 *             does not support {@code null} keys or values.
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Returns a {@code Collection} of the values contained in this
	 * {@code EnumMap}. The returned {@code Collection} complies with the
	 * general rule specified in {@link Map#values()}. The {@code Collection}'s
	 * {@code Iterator} will return the values in the their corresponding keys'
	 * natural order (the {@code Enum} constants are declared in this order).
	 * <p>
