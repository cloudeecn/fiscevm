...
abstract class AbstractCharClass extends SpecialToken {
	...
	static class LazyGraph extends LazyAlnum {
		protected AbstractCharClass computeValue() {
			/* plus punctuation */
			return ((CharClass) super.computeValue()).add(0x21, 0x40)
	...
	static final class PredefinedCharacterClasses {
		...
		static final Object[][] contents = {
				...
				{
						"Mc",
						new LazyCategory(Character.COMBINING_SPACING_MARK, true) },
				...
				{
						"IsP",
						new LazyCategoryScope((1 << Character.DASH_PUNCTUATION)
				...
				{
						"Pc",
						new LazyCategory(Character.CONNECTOR_PUNCTUATION, false) },
				...
				{
						"Pi",
						new LazyCategory(Character.INITIAL_QUOTE_PUNCTUATION,
								false) },
				{
						"Pf",
						new LazyCategory(Character.FINAL_QUOTE_PUNCTUATION,
								false) } };
		static final HashMap<String, Object> map = new HashMap<String, Object>();
		static {
			for (Object[] c : contents) {
				map.put((String) c[0], c[1]);
			}
		}
