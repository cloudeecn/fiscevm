...
public class BitSet implements Cloneable {
	 ...
	 * @return a {@code boolean} indicating whether or not this {@code BitSet}
	 *         and {@code obj} are equal.
	 * @see #hashCode
	 */
	@Override
	...
	/**
	 * Computes the hash code for this {@code BitSet}. If two {@code BitSet}s
	 * are equal the have to return the same result for {@code hashCode()}.
	 * 
	...
	/**
	 * Checks if these two {@code BitSet}s have at least one bit set to true in
	 * the same position.
	 * 
	 * @param bs
	 ...
	 * {@code BitSet}. The values of this {@code BitSet} are changed
	 * accordingly.
	 * 
	 * @param bs
	...
	/**
	 * Performs the logical OR of this {@code BitSet} with another
	 * {@code BitSet}. The values of this {@code BitSet} are changed
	 * accordingly.
	 * 
	 * @param bs
	...
	/**
	 * Performs the logical XOR of this {@code BitSet} with another
	 * {@code BitSet}. The values of this {@code BitSet} are changed
	 * accordingly.
	 * 
	 * @param bs
	 ...
	 * 
	 * @return {@code true} if the {@code BitSet} is empty, {@code false}
	 *         otherwise.
	 */
