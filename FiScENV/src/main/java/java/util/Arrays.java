...
public class Arrays {
	 ...
	 * @throws ClassCastException
	 *             if an element in the array does not implement
	 *             {@code Comparable} or if some elements cannot be compared to
	 *             each other.
	 ...
	 * @throws ClassCastException
	 *             if an element in the array does not implement
	 *             {@code Comparable} or some elements cannot be compared to
	 *             each other.
	 * @throws IllegalArgumentException
	 *             if {@code start > end}.
	 * @throws ArrayIndexOutOfBoundsException
	 ...
	 * 
	 * @param bnd
	 *            - possible values 0,-1. "-1" - val is located at index more
	...
	/**
	 * Performs a sort on the given String array. Elements will be re-ordered
	...
	/**
	 * Performs a sort on the given String array. Elements will be re-ordered
	 * into ascending order. Uses a stable ternary quick sort algorithm.
	 * 
	 * @param arr
	 *            - the array to sort
	 * @param src
	 ...
	 * {@code Comparator}. All elements must be comparable to each other without
	 * a {@code ClassCastException} being thrown.
	 * 
	 * @param array
	 *            the {@code Object} array to be sorted.
	 * @param start
	...
	/**
	 * Sorts the specified array using the specified {@code Comparator}. All
	 ...
	 * The result is surrounded by brackets ({@code &quot;[]&quot;}), each
	 * element is converted to a {@code String} via the
	 * {@link String#valueOf(float)} and separated by {@code &quot;, &quot;}. If
