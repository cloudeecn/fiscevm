...
public abstract class Reader implements Closeable {
	 ...
	 * {@code reset()} is implementation specific. This default implementation
	 ...
	 * {@code read} methods will not return these characters unless
	 * {@code reset()} is used. This method may perform multiple reads to read
