	...
	public static ClassData loadClassFromStream(InputStream is)
		...
		for (int i = 1; i < constantPoolSize; i++) {
			...
			case 11: {
				...
				c.setClazzIdx(dis.readChar());
				c.setNameAndTypeIdx(dis.readChar());
				cb.getConstantPool()[i] = c;
				break;
			}
			case 12: {
				...
				c.setNameIdx(dis.readChar());
				c.setDescriptorIdx(dis.readChar());
				cb.getConstantPool()[i] = c;
				break;
			}
			default: {
