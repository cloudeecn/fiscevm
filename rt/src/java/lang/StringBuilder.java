 ...
 * {@code StringBuilder}, so that, like {@code StringBuffer}s, they can be used
 * in chaining method calls together. For example, {@code new StringBuilder("One
...
public final class StringBuilder extends AbstractStringBuilder implements
	...
	public String toString() {
		/*
		 * Note: This method is required to workaround a compiler bug in the RI
		 * javac (at least in 1.5.0_06) that will generate a reference to the
		 * non-public AbstractStringBuilder if we don't override it here.
		 */
