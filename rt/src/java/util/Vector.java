...
public class Vector<E> extends AbstractList<E> implements List<E>,
	...
	/**
	 * Removes the element found at index position {@code location} from this
	 * {@code Vector}. All elements with an index bigger than {@code location}
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if {@code start < 0, start > end} or {@code end > size()}.
	 */
	@Override
	 ...
	 *             if the type of an element in this vector cannot be stored in
