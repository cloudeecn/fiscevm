 ...
 * 
 */
public class StringUtilsDigit extends NativeHandlerTemplate {
...
//		heap = context.getHeap();
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.digit(args[0], args[1]));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.digit.(II)I";
	}
