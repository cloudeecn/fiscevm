 ...
 * 
 */
public class StringUtilsToLowerCaseI extends NativeHandlerTemplate {
...
//		heap = context.getHeap();
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.toLowerCase(args[0]));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.toLowerCase.(I)I";
	}
