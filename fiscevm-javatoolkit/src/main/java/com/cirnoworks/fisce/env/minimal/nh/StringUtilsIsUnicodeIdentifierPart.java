 ...
 * 
 */
public class StringUtilsIsUnicodeIdentifierPart extends NativeHandlerTemplate {
...
//		heap = context.	getHeap();
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.isUnicodeIdentifierPart(args[0]) ? 1 : 0);
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.isUnicodeIdentifierPart.(I)Z";
	}
