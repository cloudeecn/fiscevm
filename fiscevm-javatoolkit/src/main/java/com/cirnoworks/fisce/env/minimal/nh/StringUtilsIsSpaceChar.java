 ...
 * 
 */
public class StringUtilsIsSpaceChar extends NativeHandlerTemplate {
...
//		heap = context.getHeap();
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.isSpaceChar(args[0]) ? 1 : 0);
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.isSpaceChar.(I)Z";
	}
