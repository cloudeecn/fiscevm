 ...
 * 
 */
public class StringUtilsGetNumbericValue extends NativeHandlerTemplate {
...
//		heap = context.getHeap();
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
			VMCriticalException {
		thread.nativeReturnInt(Character.getNumericValue(args[0]));
	}
	...
	public String getUniqueName() {
		return "com/cirnoworks/fisce/privat/StringUtils.getNumericValue.(I)I";
	}
