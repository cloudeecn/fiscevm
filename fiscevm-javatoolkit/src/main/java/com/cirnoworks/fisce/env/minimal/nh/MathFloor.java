 ...
 * 
 */
public class MathFloor extends NativeHandlerTemplate {
	...
	public void dealNative(int[] args, IThread thread) throws VMException,
		...
		double param1 = Double.longBitsToDouble(TypeUtil.intToLong(args[0],
				args[1]));
		thread.nativeReturnWide(Double.doubleToRawLongBits(Math.floor(param1)));
	}
	...
	public String getUniqueName() {
		return "java/lang/Math.floor.(D)D";
	}
